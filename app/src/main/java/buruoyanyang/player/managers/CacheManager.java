...
import buruoyanyang.player.utils.TransformUtils;
...
public class CacheManager {
	...
	public void put(String key, Bitmap value) {
		put(key, TransformUtils.bitmap2Bytes(value));
	}
	...
	public void put(String key, Bitmap value, int saveTime) {
		put(key, TransformUtils.bitmap2Bytes(value), saveTime);
	}
	...
	public Bitmap getAsBitmap(String key) {
		...
		return TransformUtils.bytes2Bitmap(getAsBinary(key));
	}
	...
	public void put(String key, Drawable value) {
		put(key, TransformUtils.drawable2Bitmap(value));
	}
	...
	public void put(String key, Drawable value, int saveTime) {
		put(key, TransformUtils.drawable2Bitmap(value), saveTime);
	}
	...
	public Drawable getAsDrawable(String key) {
		...
		return TransformUtils.bitmap2Drawable(TransformUtils.bytes2Bitmap(getAsBinary(key)));
	}
